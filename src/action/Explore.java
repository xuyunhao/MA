...
public class Explore {
	...
	public static String CurrentSerialId = null;
	...
	public static boolean run() throws Exception {
		...
		try {
			...
			case 22:
				...
				CurrentSerialId = Process.info.fairy.SerialId;
//				writeToFile(CurrentSerialId);
//System.out.println("Find the serialID = "+Crypto.Encrypt2Base64WithKey(CurrentSerialId));
	...
	private static void writeToFile(String currentSerialId2) {
