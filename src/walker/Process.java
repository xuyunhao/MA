...
public class Process {
	...
	private void execute(Action action) throws Exception {
		System.out.println("User id = "+PFBGood.userIdFake+" Serial id = "+Explore.CurrentSerialId);
//		if (Explore.CurrentSerialId == null || PFBGood.userIdFake == null){
//			Go.log("不能點贊");
//		}
//		else{
//			if(PFBGoodFake.run2(Explore.CurrentSerialId, PFBGood.userIdFake)) {
//				Go.log("點贊");
//				Go.log(ErrorData.text);
//				ErrorData.clear();
//			} else {
